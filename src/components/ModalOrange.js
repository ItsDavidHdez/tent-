...
const ModalOrange = ({ setShowModal }) => {
  return (
    <>
      ...
      <div className="fixed text-gray-500 flex items-center justify-center overflow-auto z-50 bg-gray-300 bg-opacity-10 left-0 right-0 top-0 bottom-0 w-screen">
        <div
          x-show="showModal"
        ...
        >
          ...
          <ul className="mb-5">
            <li>Ayuda a prevenir la diabetes.</li>
            <li>Refuerza el sistema inmunológico.</li>
            <li>Reduce el colesterol.</li>
            <li>Mejora el funcionamiento cardiovascular.</li>
          </ul>
